const data = [
{
	...
	value: "Data annotation for camera trap wildlife monitoring is typically extensive and expensive, DEEP LEARNING, MACHINE LEARNING, Annotation burden is relieved and model updates are enabled, Wildlife imagery data",
	loop: [
		{
		   "actor":"algorithm",
