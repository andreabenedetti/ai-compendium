const data = [
  ...
  }, 
  {
    ...
    loop: [
      {
        ...
        "label": "Curate and label medical images for training and testing."
      },
      {
        "actor": "algorithm",
        "index": 4,
        ...
        "label": "Generate stochastic predictions using Monte Carlo Dropout, capturing aleatoric and epistemic uncertainties in the segmentation outputs."
      },
      {
        "actor": "human",
        "index": 2,
        "type": "Expert",
        "title": "Uncertainty Estimation",
        "label": "Evaluate the uncertainty metrics (aleatoric uncertainty, epistemic uncertainty, entropy, and mutual information) to understand the model's confidence in its predictions."
      },
      {
        "actor": "algorithm",
        "index": 3,
        "type": "MCU-Net model",
        "title": "Uncertainty Thresholding",
        "label": "Apply an uncertainty threshold (τ) to the model's predictions, determining the level of uncertainty for each case."
      },
      {
        "actor": "human",
        "index": 3,
        "type": "Expert",
        "title": "Uncertainty Thresholding",
        "label": "Define and validate the threshold τ based on domain knowledge and the desired balance between automated decision-making and human intervention."
      },
      {
        "actor": "algorithm",
        "index": 2,
        "type": "MCU-Net model",
        "title": "Automated Referral",
        "label": "Flag cases with high uncertainty, surpassing the defined threshold τ, for referral to medical professionals."
      },
      {
        "actor": "human",
        "index": 4,
        "type": "Expert",
        "title": "Automated Referral",
        "label": "Review flagged cases, leveraging their Expertise to assess and make decisions based on the uncertain predictions provided by the model."
      },
      {
        "actor": "human",
        "index": 5,
        ...
        "label": "Provide feedback and corrective actions based on the model's uncertain predictions, ensuring that critical cases are appropriately flagged for further assessment."
      },
      {
        "actor": "algorithm",
        "index": 1,
        "type": "MCU-Net model",
        "title": "Human-in-the-Loop Intervention",
        "label": "Incorporate human feedback to improve the model's performance and refine the uncertainty thresholding process."
      }
    ]
  }, {
    ...
    loop: [
      {
        ...
        "index": 5,
        "type": "NLG Pipeline",
        "title": "Extraction of Action Phrases and Initiation of Sentences from API Description",
        "label": "Algorithm extracts phrases from OpenAPI specification and possibly augments them with human-provided phrases."
      },
      {
        "actor": "algorithm",
        "index": 4,
        ...
        "label": "Algorithm generates equivalent sentences using a variety of language models."
      },
      {
        "actor": "human",
        "index": 1,
        "type": "API Developer",
        "title": "Feedback of generated sentences",
        "label": "API developer interacts with the system through a web UI to provide feedback on the generated sentences."
      },
      {
        "actor": "algorithm",
        "index": 3,
        ...
        "label": "Algorithm filters the generated sentences to eliminate noisy ones and selects a diverse set of sentences based on human feedback."
      },
      {
        "actor": "human",
        "index": 2,
        "type": "API Developer",
        "title": "Selection of Sentences",
        "label": "API developer selects appropriate sentences for training the intent classifier."
      },
      {
        "actor": "algorithm",
        "index": 2,
        "type": "Intent Recognition Model",
        "title": "Model Training",
        "label": "Algorithm trains the intent recognition model for the chatbot."
      },
      {
        "actor": "algorithm",
        "index": 1,
        ...
        "label": "Trained intent classifier is deployed and serves to classify Users’ intents based on their input utterances in the dialog system while attempting to invoke an API endpoint conversationally."
      }
    ]
  }, {
    ...
    value: {
      problems: ["Opaqueness"],
      data: ["Explanations"],
      promises: ["Human collaboration", "Acceptance"],
      humans: ["End-User"]
    },
    loop: [
      {
        ...
        "label": "The AI system identifies differences between its own model and the human's model."
      },
      {
        "actor": "algorithm",
        "index": 3,
        ...
        "label": "The AI system utilizes algorithms to automatically compute explanations that suggest changes to the human's model."
      },
      {
        "actor": "algorithm",
        "index": 2,
        "type": "AI system",
        "title": "Presenting Explanations",
        "label": "The AI system presents these explanations to the human, highlighting the suggested changes to the human's model."
      },
      {
        "actor": "human",
        "index": 1,
        "type": "User",
        "title": "Reviewing Explanations",
        "label": "The human reviews the explanations and considers the suggested changes to their model."
      },
      {
        "actor": "human",
        "index": 2,
        ...
        "label": "Based on the explanations and suggested changes, the human updates their model to align it with the AI system's model."
      },
      {
        "actor": "algorithm",
        "index": 1,
        "type": "AI system",
        "title": "Optimizing Plans and Behavior",
        "label": "With the reconciled model, the AI system optimizes its plans and behavior to be in line with the updated human model."
      }
    ]
  }, {
    ...
    loop: [
      {
        ...
        "index": 1,
        "type": "Decision maker",
        "title": "Identify tasks/goals",
        "label": "Human identifies the tasks or goals to be accomplished in a complex planning environment."
      },
      {
        "actor": "algorithm",
        "index": 3,
        "type": "automated planner",
        "title": "Generate plan/COA",
        "label": "Automated planning system (RADAR) receives the model of the world, initial state, and goals/tasks from the human Decision maker. RADAR's automated planner analyzes the provided information and generates a plan or course-of-action (COA) based on the given model and goals."
      },
      {
        "actor": "algorithm",
        "index": 2,
        "type": "automated planner",
        "title": "Monitor planning process",
        "label": "The automated planner continuously monitors the planning process of the human Decision maker and the current state of the environment."
      },
      {
        "actor": "algorithm",
        "index": 1,
        "type": "automated planner",
        "title": "Provide alerts/suggestions",
        "label": "Based on the current state and resource availability, RADAR's automated planner provides alerts and suggestions to the human Decision maker regarding potential drawbacks in the plan, resource constraints, or problems that may arise in the future."
      },
      {
        "actor": "human",
        "index": 2,
        "type": "Decision maker",
        "title": "Evaluate alerts/suggestions",
        "label": "Human Decision maker evaluates the alerts and suggestions provided by RADAR and incorporates them into their decision-making process as they see fit."
      }
    ]
  }, {
    ...
    loop: [
      {
        ...
        "index": 1,
        "type": "User",
        "title": "Input Text Instructions",
        "label": "Provides natural language text instructions describing the desired scene or modifications to an existing sketch."
      },
      {
        "actor": "algorithm",
        "index": 3,
        "type": "deep learning model",
        "title": "Machine Learning-driven Interpretation",
        "label": "Utilizes deep learning models to interpret the natural language input and understand the User's instructions."
      },
      {
        "actor": "algorithm",
        "index": 2,
        "type": "sketch generation model",
        "title": "Sketch Generation",
        "label": "Generates sketched scenes based on the interpreted text instructions, using state-of-the-art deep neural network architectures."
      },
      {
        "actor": "human",
        "index": 2,
        "type": "User",
        "title": "User Feedback and Refinement",
        "label": "Reviews the generated sketches and provides feedback or additional instructions for refinement."
      },
      {
        "actor": "algorithm",
        "index": 1,
        "type": "sketch generation model",
        "title": "User Feedback and Refinement",
        "label": "Incorporates User feedback and iteratively refines the sketches based on the provided instructions."
      }
    ]
  }
];
